...
def get_event_detailinfo (event):
    url = event.get("href")
        ...
        try:
            ...
            for content_card in content_cards:
                ...
                if 'Presented by' in content_card.text:
                    presenters = []
                    presenters_elements = content_card.find_elements(By.CSS_SELECTOR, "div > div > div.jsx-1380439751.flex-center.gap-2")
                    ...
                    event_detail_info['presenters'] = presenters
                    continue
            ...
            try:
                ...
                event_time = row_elements[0].find_element(By.CLASS_NAME, "jsx-2370077516.desc.text-ellipses").text
                event_detail_info["time"] = event_date + event_time
                event_street_addr = row_elements[1].find_element(By.CLASS_NAME, "jsx-2370077516.title.text-ellipses").text
                event_local_addr = row_elements[1].find_element(By.CLASS_NAME, "jsx-2370077516.desc.text-ellipses").text
                event_addr = {}
                event_addr["streetAddr"] = event_street_addr
                event_addr["localAddr"] = event_local_addr
                event_detail_info["addr"] = event_addr

                bottom_element = driver.find_element(By.CLASS_NAME, 'bottom-section') 
                content_cards = bottom_element.find_elements(By.CLASS_NAME, "content-card")
                for content_card in content_cards:
                    tags = [],
